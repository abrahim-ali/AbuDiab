import{r as d,j as e}from"./index-l5wjVP_F.js";import{t as b,W as v,H as N,F as S}from"./Footer-CUVBZxeC.js";import{F as w,a as k,b as A,c as D,d as E,e as I}from"./index-D3KNT98Q.js";import{T as C}from"./TestimonialsPage-zjg68RD4.js";import{H as z}from"./Helmet-ZfQ0FUeD.js";function W({lang:i}){const[n,m]=d.useState(""),t=b("hero.text",i),s=100,r=1500,g=50;return d.useEffect(()=>{let a;const o=()=>{m(c=>{const f=t.slice(0,c.length+1);return f.length<t.length?a=setTimeout(o,s):f.length===t.length&&(a=setTimeout(l,r)),f})},l=()=>{m(c=>c.length>1?(a=setTimeout(l,g),c.slice(0,-1)):(a=setTimeout(o,s),""))};return a=setTimeout(o,s),()=>clearTimeout(a)},[i]),e.jsx(v,{children:e.jsxs("section",{className:"hero",id:"home",children:[e.jsx("style",{children:`
          .cursor {
